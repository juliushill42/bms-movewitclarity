...
export async function load({ locals, url }) {
  let tenantSlug = locals.tenant || url.searchParams.get('tenant');
  if (!tenantSlug || !businessDatabase[tenantSlug]) { return { isHubHomepage: true }; }
  return { isHubHomepage: false, business: businessDatabase[tenantSlug] };
}
